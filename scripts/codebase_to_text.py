...
TARGET_FOLDERS = ["lib", "app"]
EXCLUDE_PATTERNS = [
    "lib/integrations/actions",  # Exclude all action files
    "lib/integrations/logic",    # Exclude all logic files  
    "lib/integrations/triggers"  # Exclude all trigger files
]
INCLUDE_EXAMPLES = {
    "lib/integrations/actions": 1,    # Include 1 random example from actions
    "lib/integrations/logic": 1,      # Include 1 random example from logic
    "lib/integrations/triggers": 1    # Include 1 random example from triggers
}
